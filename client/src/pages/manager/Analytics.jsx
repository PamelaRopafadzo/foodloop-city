    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">AI weekly report</h2>
            <p className="text-sm text-gray-500">Generated by Claude</p>
          </div>
          <button
        ...
        {report ? (
          <div className="bg-gray-50 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              {report.fallback && (
                <span className="text-xs text-gray-400">(Claude API not configured — fallback report)</span>
              )}
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-8 text-center">
            <p className="text-gray-400 text-sm">
              Click "Generate report" for a personalised AI analysis of this week's waste
            </p>
          </div>
        )}
      </div>
